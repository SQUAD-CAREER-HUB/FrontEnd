...
interface AddInterviewScheduleProps {
  setOpen: React.Dispatch<React.SetStateAction<boolean>>;
}

export default function AddInterviewSchedule({ setOpen }: AddInterviewScheduleProps) {
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="flex flex-col gap-1">
            <FormLabel className="m-0" htmlFor="location">장소 및 링크</FormLabel>
            <Input
              id="location"
              type="text"
              placeholder="장소/링크"
